   ...
   if($method == "pay_online")
   {
      ...
      if($check_cart->rowCount() > 0){
         ...
         if($address == ''){
            ...
            $insert_order->execute([$user_id, $name, $number, $email, $method, $address, $total_products, $total_price, $comp]);
      ...
      header("location: pay/pay_online.php?name=$name&price=$total_price");
